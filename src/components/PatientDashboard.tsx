    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-green-500 rounded-2xl p-8 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          ...
          <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
            <div className="text-2xl font-bold">{takenMeds.has(totalMeds) ? "✓" : "○"}</div>
      ...
      <p>
        {totalMeds === 0
          ...
          : `You've taken ${takenMeds} out of ${totalMeds} today. (${adherence}%)`}
      </p></div>
          ...
          <Card className="h-fit">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-2xl">
                ...
                <button onClick={handleNavigate} id="button-ptn"> Add medicine</button>
              </CardTitle>
              <AddMedicationList  medications={medications}
              toggleTaken={(i)=>{
                console.log(i);
                toggleTaken(i)
              }}
        ...
        <div className="lg:col-span-2">
          <Card className="h-fit">
            <CardHeader>
              ...
              <AddMedicationList  medications={medications} toggleTaken={(i)=> toggleTaken(i)} />
            </CardHeader>
            <CardContent>
              <MedicationTracker 
                date={selectedDateStr}
